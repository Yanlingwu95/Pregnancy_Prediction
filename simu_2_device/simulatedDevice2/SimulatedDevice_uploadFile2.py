...
def device_method_callback(method_name, payload, user_context):
    ...
    if method_name == "send_file":
        ...
        block_blob_service.create_blob_from_path(
                            ...
                            'real_time_data2.csv', # local file name
                            content_settings=ContentSettings(content_type='csv'))
        response = filename
        error = False
        file_output = open("./real_time_data2.csv",'w')
        file_output.close()
...
def iothub_client_telemetry_sample_run():
    ...
    try:
        ...
        for line in file:
            file_output = open("./real_time_data2.csv",'a')
            print(line)
...
if __name__ == '__main__':
    print ( "IoT Hub #2 - Simulated device-2" )
