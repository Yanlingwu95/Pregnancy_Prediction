...
CONNECTION_STRING ="HostName=Trail427.azure-devices.net;DeviceId=sim1;SharedAccessKey=U4i0YRq7w6OVXZWXCjZd/bxwDSe5T2IQ0zBYAQHXWEw="
...
def device_method_callback(method_name, payload, user_context):
    ...
    if method_name == "send_file":
        ...
        block_blob_service.create_blob_from_path(
                            ...
                            'real_time_data1.csv', # local file name
                            content_settings=ContentSettings(content_type='csv'))
        response = filename
        error = False
        file_output = open("./real_time_data1.csv",'w')
        file_output.close()
...
def iothub_client_telemetry_sample_run():
    ...
    try:
        ...
        for line in file:
            file_output = open("./real_time_data1.csv",'a')
            print(line)
...
if __name__ == '__main__':
    print ( "IoT Hub #1 - Simulated device-1" )
